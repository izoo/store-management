...
<div class="col-md-6">
    <div class="form-group">
    {!! Form::label('state','County' . ':*') !!}
    <div class="input-group">
        <span class="input-group-addon">
            <i class="fa fa-map-marker"></i>
        </span>
        {!! Form::text('state', null, ['class' => 'form-control','placeholder' => 'County', 'required']); !!}
    </div>
    </div>
</div>
<div class="clearfix"></div>
...
<div class="col-md-6">
    <div class="form-group">
    {!! Form::label('zip_code', 'P,O BOX' . ':*') !!}
    <div class="input-group">
        <span class="input-group-addon">
            <i class="fa fa-map-marker"></i>
        </span>
        {!! Form::text('zip_code', null, ['class' => 'form-control','placeholder' => 'P,O BOX' , 'required']); !!}
    </div>
    </div>
</div>
<div class="clearfix"></div>
<div class="col-md-6">
    ...
    <div class="input-group">
        ...
        {!! Form::text('landmark', null, ['class' => 'form-control','placeholder' => 'Town', 'required']); !!}
    </div>
    </div>
</div>
<div class="col-md-6">
