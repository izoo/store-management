    ...
    <div class="container-fluid">
        <div class="row eq-height-row">
            ...
            <div class="col-md-7 col-sm-7 col-xs-12 right-col eq-height-col">
                ...
                <div class="col-md-12 col-xs-12" style="text-align: right;padding-top: 10px;">
                    @if(!($request->segment(1) == 'business' && $request->segment(2) == 'register'))
                        <!-- Register Url -->
                        @if(config('constants.allow_registration'))
                            <a style="display:none;" href="{{ route('business.getRegister') }}@if(!empty(request()->lang)){{'?lang=' . request()->lang}} @endif" class="btn bg-maroon btn-flat" ><b>{{ __('business.not_yet_registered')}}</b> {{ __('business.register_now') }}</a>
                            <!-- pricing url -->
